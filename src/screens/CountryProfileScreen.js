...
export default function CountryProfileScreen({ navigation, route }) {
  ...
  // For labeling: show around 5 labels max on x-axis
                ...
                <View>
                  <Svg width={width} height={height}>
                    ...
                    <SvgText
                      ...
                      fontWeight="400"
                      textAnchor="middle"
                      transform={`rotate(-90, ${paddingLeft - 45}, ${
                        height / 2
                      })`}
                    >
                    ...
                    {[0, 0.25, 0.5, 0.75, 1].map((t, i) => (
                      <Line
                        ...
                        x1={paddingLeft}
                        y1={
                          paddingTop + t * (height - paddingTop - paddingBottom)
                        }
...
const styles = StyleSheet.create({
  ...
  region: { fontSize: 17, color: '#060606ff', fontWeight: '600' },
  headerRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
